const weeks = [
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ...
        ['18:30–19:50', 'Теоретическая информатика (ЛЕКЦ)', '4204 м', 'Лек']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ...
        ['14:00–15:20', 'Моделирование. Часть 1 (ПРАК)', '3107 м', 'Пр'],
  ...
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['12:00–13:20 / 12:30–13:50', 'Моделирование. Часть 1 (ПРАК)', '3112', 'Пр'],
        ['14:00–15:20', 'Моделирование. Часть 1 (ЛЕКЦ)', '3210 МПСУ', 'Лек'],
        ['15:30–16:50', 'Технология и конструирование ИМС (ЛЕКЦ)', '1205 м', 'Лек'],
        ['17:00–18:20', 'Теоретическая информатика (ЛЕКЦ)', '1201 м', 'Лек'],
        ['18:30–19:50', 'Проектный менеджмент (ЛЕКЦ)', '1201 м', 'Лек']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ['09:00–10:20', 'Иностранный язык для профессиональной коммуникации (ПРАК)', '3223 ОМС', 'Пр'],
        ['10:30–11:50', '', '', ''],
        ['12:00–13:20 / 12:30–13:50', 'Научно-техническая документация в профессиональной коммуникации (ПРАК)', '3223 ОМС', 'Пр'],
        ['14:00–15:20', 'Визуализация результатов научных исследований (ЛЕКЦ)', '3107 м', 'Лек'],
        ['15:30–16:50', 'Проектный менеджмент (ПРАК)', '1202 м', 'Пр']
      ]},
      { name: 'Saturday', ru: 'Суббота', lessons: [
        ['12:00–13:20 / 12:30–13:50', 'З-I | Визуализация результатов научных исследований (ЛАБО)', '3120а', 'Лаб'],
        ['14:00–15:20', '', '', '']
      ]}
    ]
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['12:00–13:20 / 12:30–13:50', 'Ч-II | Технология и конструирование ИМС (ЛАБО)', '4116л НМСТ', 'Лаб'],
        ['14:00–15:20', '', '', ''],
        ['15:30–16:50', 'Теоретическая информатика (ЛАБО)', '4330л МПСУ', 'Лаб'],
        ['17:00–18:20', '', '', ''],
        ['18:30–19:50', 'Теоретическая информатика (ЛЕКЦ)', '4204 м', 'Лек']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ['09:00–10:20', 'Иностранный язык для профессиональной коммуникации (ПРАК)', '3223', 'Прак'],
        ['10:30–11:50', '', '', ''],
        ['12:00–13:20', 'Научно-техническая документация в профессиональной коммуникации (ПРАК)', '3224', 'Прак'],
        ['12:30–13:50', '', '', ''],
        ['14:00–15:20', 'Моделирование. Часть 1 (ПРАК)', '3107 м', 'Пр'],
        ['15:30–16:50', 'Визуализация результатов научных исследований (ЛАБО)', '3120а', 'Лаб']
      ]}
