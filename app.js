const weeks = [
  {
    ...
    days: [
      ...
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ...
        ['12:00–13:20', 'Научно-техническая Документация В Профессиональной Коммуникации (ПРАК)', '3223', 'RUSSIAN LANGUAGE'],
        ['14:00–15:20', 'Моделирование Часть 1 (ПРАК)', '3107', 'MODELING'],
        ['15:30–16:50', 'Визуализация Результатов Научных Исследований (ЛАБО)', '3120', 'VISUALIZATION']
      ]}
    ]
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['12:30–13:50', 'Моделирование Часть 1 (ПРАК)', '3112', 'MODELING'],
        ['14:00–15:20', 'Моделирование Часть 1 (ЛЕКЦ)', '3210', 'MODELING'],
        ['15:30–16:50', 'Технология И Конструирование ИМС (ЛЕКЦ)', '1205', 'TECHNOLOGY & DESIGN OF INTEGRATED CIRCUITS'],
        ['17:00–18:20', 'Теоретическая Информатика (ЛЕКЦ)', '1201', 'C++'],
        ['18:30–19:50', 'Проектный Менеджмент (ЛЕКЦ)', '1201', 'PROJECT MANAGEMENT']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ['09:00–10:20 / 10:30–11:50', 'Иностранный Язык Для Профессиональной Коммуникации (ПРАК)', '3223', 'RUSSIAN LANGUAGE'],
        ['12:00–13:20', 'Научно-техническая Документация В Профессиональной Коммуникации (ПРАК)', '3223', 'RUSSIAN LANGUAGE'],
        ['14:00–15:20', 'Визуализация Результатов Научных Исследований (ЛЕКЦ)', '3107', 'VISUALIZATION'],
        ['15:30–16:50', 'Проектный Менеджмент (ПРАК)', '1202', 'PROJECT MANAGEMENT']
      ]},
      { name: 'Saturday', ru: 'Суббота', lessons: [
        ['12:30–13:50 / 14:00–15:20', 'Визуализация Результатов Научных Исследований (ЛАБО)', '3120', 'VISUALIZATION'],
      ]}
    ]
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['12:00–13:20 / 14:00–15:20', 'Технология И Конструирование ИМС (ЛАБО)', '4116', 'TECHNOLOGY & DESIGN OF INTEGRATED CIRCUITS'],
        ['15:30–16:50 / 17:00–18:20', 'Теоретическая Информатика (ЛАБО)', '4330', 'C++'],
        ['18:30–19:50', 'Теоретическая Информатика (ЛЕКЦ)', '4204', 'C++']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
  ...
  },
  {
    ...
    days: [
      ...
      { name: 'Saturday', ru: 'Суббота', lessons: [
        ['15:30–16:50 / 17:00–18:20', 'Визуализация Результатов Научных Исследований (ЛАБО)', '3120', 'VISUALIZATION']
      ]}
    ]
  }
];
