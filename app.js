const weeks = [
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['10:30–11:50 / 12:00-13:20 / 12:30-13:50', 'Ч-I | Моделирование. Часть 1 (ЛАБО)', '3202л МПСУ', 'MODELING'],
        ['15:30–16:50 / 17:00-18:20', 'Теоретическая информатика (ЛАБО)', '4330л МПСУ', 'C++'],
        ['18:30–19:50', 'Теоретическая информатика (ЛЕКЦ)', '4204 м', 'C++']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ...
        ['14:00–15:20', 'Моделирование. Часть 1 (ПРАК)', '3107 м', 'MODELING'],
  ...
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ...
        ['15:30–16:50', 'Технология и конструирование ИМС (ЛЕКЦ)', '1205 м', 'TECH & CONSTRUCTION'],
        ['17:00–18:20', 'Теоретическая информатика (ЛЕКЦ)', '1201 м', 'C++'],
        ['18:30–19:50', 'Проектный менеджмент (ЛЕКЦ)', '1201 м', 'PROJECT MANAGEMENT']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
        ...
        ['14:00–15:20', 'Визуализация результатов научных исследований (ЛЕКЦ)', '3107 м', 'VISUALIZATION'],
        ['15:30–16:50', 'Проектный менеджмент (ПРАК)', '1202 м', 'PROJECT MANAGEMENT']
      ]},
      { name: 'Saturday', ru: 'Суббота', lessons: [
        ['12:00–13:20 / 12:30–13:50 / 14:00–15:20', 'З-I | Визуализация результатов научных исследований (ЛАБО)', '3120а', 'VISUALIZATION'],
      ]}
    ]
  },
  {
    ...
    days: [
      { name: 'Wednesday', ru: 'Среда', lessons: [
        ['12:00–13:20 / 12:30–13:50 / 14:00–15:20', 'Ч-II | Технология и конструирование ИМС (ЛАБО)', '4116л НМСТ', 'TECH & CONSTRUCTION'],
        ['15:30–16:50 / 17:00–18:20', 'Теоретическая информатика (ЛАБО)', '4330л МПСУ', 'C++'],
        ['18:30–19:50', 'Теоретическая информатика (ЛЕКЦ)', '4204 м', 'C++']
      ]},
      { name: 'Thursday', ru: 'Четверг', lessons: [
  ...
  },
  {
    ...
    days: [
      ...
      { name: 'Saturday', ru: 'Суббота', lessons: [
        ['15:30–16:50 / 17:00–18:20', 'З-II | Визуализация результатов научных исследований (ЛАБО)', '3120а', 'VISUALIZATION']
      ]}
    ]
  }
];
